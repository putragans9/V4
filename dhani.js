...
┏━━⬣  SYARAT && KETENTUAN
┃⬡
┃⬡ Jika Bot Sudah Join, Jadin admin
┃⬡ No Buly Bot && Owner Bot
┃⬡ Sewa Bot Jangan Pc Bot 
┃⬡ Sewa Bot Pc ke Owner
┃⬡ Minta Sv, Ke No Owner Aja
┃⬡ Auto Read? Bot active bg
┃⬡ No Spam Ya
┃⬡
┗━━⬣
...
JIKA BOT OFFLINE BERARTI KUOTA HABIS /SIBUK!
...
reply(`${err}`)
	...
	Dhani.sendMessage(`${owner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer KurumiXyandere",body:"Jangan Lupa Follow Ig ikygans05",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/dhani.jpg'),sourceUrl:"https://wa.me/6281333603591"}}})
        }
	// console.log(e)
	}
}
